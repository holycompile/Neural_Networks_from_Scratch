#we will see that the strategy 2 doesnt not work for the spiral data set 
#this is the Strategy 2 which DOES WORK FOR THE spiral DATA SET 
#the loss still remains about 1.....
import numpy as np
import nnfs 
